...
CUDA_PATH ?= /share/apps/cuda/cuda-6.5
...
INCLUDES  += -I/share/apps/cuDNN/cudnn-6.5-linux-x64-v2/
LIBRARIES := -L/share/apps/cuDNN/cudnn-6.5-linux-x64-v2/ -l cudnn
...
$(shell echo "int main() { omp_get_num_threads(); return 0; }" > test.c ; $(NVCC) -Xcompiler -fopenmp test.c)
