...
void cmdLine(int argc, char *argv[], double& T, int& n, int& px, int& py, int& plot_freq, int& no_comm, int& num_threads, int& b){
/// Command line arguments
 ...
 for(ac=1;ac<argc;ac++) {
    int c;
    while ((c=getopt_long(argc,argv,"n:b:x:y:t:kp:o:",long_options,NULL)) != -1){
        switch (c) {
